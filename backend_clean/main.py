...
# UI ROUTE DISABLED - # UI ROUTE DISABLED - @app.get("/payment-accounts.html")
async def payment_accounts_page():
    """Serve payment accounts page directly"""
    return FileResponse("static/payment-accounts.html")

# UI ROUTE DISABLED - # UI ROUTE DISABLED - @app.get("/payment-accounts")
...
# UI ROUTE DISABLED - # UI ROUTE DISABLED - @app.get("/onboarding")
...
# UI ROUTE DISABLED - # UI ROUTE DISABLED - @app.get("/voice-expenses")
...
# UI ROUTE DISABLED - # UI ROUTE DISABLED - @app.get("/client-settings")
...
# UI ROUTE DISABLED - # UI ROUTE DISABLED - @app.get("/automation-viewer")
...
# UI ROUTE DISABLED - # UI ROUTE DISABLED - @app.get("/bank-reconciliation")
...
# UI ROUTE DISABLED - # UI ROUTE DISABLED - @app.get("/auth/login")
async def auth_login_page():
    """
...
# UI ROUTE DISABLED - # UI ROUTE DISABLED - @app.get("/auth/register")
...
# UI ROUTE DISABLED - # UI ROUTE DISABLED - @app.get("/admin")
...
# UI ROUTE DISABLED - # UI ROUTE DISABLED - @app.get("/sat-accounts")
...
# UI ROUTE DISABLED - # UI ROUTE DISABLED - @app.get("/polizas-dashboard")
...
# UI ROUTE DISABLED - # UI ROUTE DISABLED - @app.get("/financial-reports")
...
# UI ROUTE DISABLED - # UI ROUTE DISABLED - @app.get("/expenses-viewer")
...
# UI ROUTE DISABLED - # UI ROUTE DISABLED - @app.get("/complete-expenses")
...
# UI ROUTE DISABLED - # UI ROUTE DISABLED - @app.get("/landing")
...
# UI ROUTE DISABLED - # UI ROUTE DISABLED - @app.get("/onboarding-context")
