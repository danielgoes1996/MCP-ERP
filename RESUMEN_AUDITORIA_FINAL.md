...
**`universal_invoice_sessions`** ⚠️ FALTA CAMPO
```sql
Table "public.universal_invoice_sessions"
...
|-----------|-----------|-------------|-----------------|
| Campo `accounting_classification` en `universal_invoice_sessions` | Guardar clasificación JSONB | Baja | 15 min |
...
#### Base de Datos
- ❌ Campo `accounting_classification` en `universal_invoice_sessions` (JSONB)
...
2. Universal Invoice Engine procesa
   ...
   - Valida estructura
   - Guarda en universal_invoice_sessions
   ↓
