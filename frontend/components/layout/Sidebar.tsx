...
const navigation: NavItem[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { name: 'Credenciales SAT', href: '/sat-credentials', icon: FileCheck, color: 'text-gray-600' },
      { name: 'Configuración SAT', href: '/sat-config', icon: Settings, color: 'text-gray-600' },
      { name: 'Dashboard SAT', href: '/sat-sync-dashboard', icon: BarChart3, color: 'text-gray-600' },
