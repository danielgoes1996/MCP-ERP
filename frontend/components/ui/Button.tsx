...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variants = {
      primary:
        'bg-gradient-to-r from-[#11446e] to-[#0d3454] text-white hover:shadow-lg hover:shadow-[#11446e]/20 focus:ring-[#11446e]',
      secondary:
        'bg-[#60b97b] text-white hover:shadow-lg hover:shadow-[#60b97b]/20 focus:ring-[#60b97b]',
      outline:
